...
export const proposal = {
  slug: 'kunde-slug',
  host: 'kunde-slug.holisti.no',
  siteUrl: 'https://kunde-slug.holisti.no',

  // Feature-flagg: slå av/på hvilke sider som vises i forslagsrommet, per kunde.
  // Utelatt eller true = vises. false = skjules i panelet og via URL.
  modules: {
    pages: {
      hjem: true,
      om: true,
  ...
  offer: {
    ...
    intro:
      'Takk for hyggelig samtale og for materialet du sendte over. Under finner du forslag til hvordan siden kan se ut, og et klart tilbud på hva som er med.',
    quoteHook: 'Et sitat eller hook som treffer kunden',
